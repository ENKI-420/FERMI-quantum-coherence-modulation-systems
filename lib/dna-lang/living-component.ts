...
export class LivingComponentManager {
  ...
  // Add comment above fix: Use ReturnType<typeof setTimeout> instead of NodeJS.Timeout for browser compatibility
  private regenerationInterval: ReturnType<typeof setTimeout> | null = null

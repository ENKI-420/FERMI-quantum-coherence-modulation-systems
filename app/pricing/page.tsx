        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {tiers.map((tier) => {
              ...
              // Add comment above fix: Ensure numeric price values before arithmetic to avoid string comparison/multiplication errors
              const monthlyVal = typeof tier.price.monthly === "number" ? tier.price.monthly : 0
              const annualVal = typeof tier.price.annual === "number" ? tier.price.annual : 0
                ...
                >
                  ...
                  <div className="mb-6">
                    {typeof tier.price.monthly === "number" ? (
                      <>
                        <span className="text-4xl font-bold">${isAnnual ? annualVal : monthlyVal}</span>
                        <span className="text-muted-foreground">/month</span>
                        {isAnnual && monthlyVal > 0 && (
                          <p className="text-xs text-muted-foreground mt-1">
                            Billed annually (${annualVal * 12}/year)
                          </p>
                        )}
                      </>
                    ) : (
